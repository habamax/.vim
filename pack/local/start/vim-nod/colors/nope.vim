...
" License:      Same as Vim
" Last Updated: 22/02/2024 9:43:23
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#d7005f', '#008700', '#af5f00', '#005faf', '#af00af', '#008787', '#dadada', '#8a8a8a', '#ff0087', '#00af5f', '#d7875f', '#0087d7', '#d700d7', '#00afaf', '#ffffff']
endif
...
hi Folded guifg=#8a8a8a guibg=#f0f0f0 gui=NONE cterm=NONE
