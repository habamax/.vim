...
" License:      Same as Vim
" Last Updated: Fri 02 Feb 2024 01:19:13 PM AEDT
...
hi! link lspDiagVirtualTextWarning WarningMsg
hi! link lspDiagSignWarningText WarningMsg
hi! link lspDiagVirtualTextHint Added
hi! link lspDiagSignHintText Added
hi! link lspDiagVirtualTextInfo Changed
hi! link lspDiagSignInfoText Changed
hi! link rstSectionDelimiter Statement
hi! link rstDirective Special

if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1c', '#d75f87', '#00af5f', '#d7875f', '#0087d7', '#d75fd7', '#00afaf', '#d0d0d0', '#767676', '#ff5f87', '#00d75f', '#ffaf5f', '#00afff', '#ff87ff', '#00d7d7', '#ffffff']
endif
