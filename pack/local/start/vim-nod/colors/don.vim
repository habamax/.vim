...
" License:      Same as Vim
" Last Updated: Tue 13 Feb 2024 05:17:03 PM AEDT
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#d7005f', '#008700', '#af5f00', '#005fd7', '#af00af', '#008787', '#eeeeee', '#9e9e9e', '#ff0087', '#00af00', '#d7875f', '#0087ff', '#d700d7', '#00afaf', '#ffffff']
endif
...
hi Todo guifg=#00af00 guibg=#eeeeee gui=bold,reverse cterm=bold,reverse
hi Search guifg=#eeeeee guibg=#005fd7 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi Todo ctermfg=34 ctermbg=255 cterm=bold,reverse
  hi Search ctermfg=255 ctermbg=26 cterm=NONE
...
if s:t_Co >= 16
  ...
  hi Todo ctermfg=green ctermbg=grey cterm=bold,reverse
...
" Color: color12                 #0087ff        33             darkblue
