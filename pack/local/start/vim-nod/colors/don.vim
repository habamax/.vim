...
" License:      Same as Vim
" Last Updated: Tue 13 Feb 2024 22:17:20
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#d7005f', '#008700', '#af5f00', '#005faf', '#af00af', '#008787', '#eeeeee', '#8a8a8a', '#ff0087', '#00af00', '#d7875f', '#0087ff', '#d700d7', '#00afaf', '#ffffff']
endif
...
hi PmenuSel guifg=#eeeeee guibg=#af5f00 gui=NONE cterm=NONE
...
hi Search guifg=#eeeeee guibg=#005faf gui=NONE cterm=NONE
hi IncSearch guifg=#eeeeee guibg=#af5f00 gui=NONE cterm=NONE
hi WildMenu guifg=#eeeeee guibg=#af5f00 gui=NONE cterm=NONE
...
hi Visual guifg=#0087af guibg=#eeeeee gui=reverse cterm=reverse
hi VisualNOS guifg=#eeeeee guibg=#8a8a8a gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi PmenuSel ctermfg=255 ctermbg=130 cterm=NONE
  ...
  hi Search ctermfg=255 ctermbg=25 cterm=NONE
  hi IncSearch ctermfg=255 ctermbg=130 cterm=NONE
  hi WildMenu ctermfg=255 ctermbg=130 cterm=NONE
  hi debugPC ctermfg=25 ctermbg=NONE cterm=reverse
  hi debugBreakpoint ctermfg=30 ctermbg=NONE cterm=reverse
  hi Visual ctermfg=31 ctermbg=255 cterm=reverse
  hi VisualNOS ctermfg=255 ctermbg=245 cterm=NONE
...
if s:t_Co >= 16
  ...
  hi IncSearch ctermfg=grey ctermbg=darkyellow cterm=NONE
  hi WildMenu ctermfg=grey ctermbg=darkyellow cterm=NONE
