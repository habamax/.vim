...
" Last Updated: 2022-07-27 13:36:29
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#af5f5f', '#5fd75f', '#af875f', '#5f87af', '#d787af', '#5fafaf', '#bcbcbc', '#878787', '#ff5f5f', '#87ff5f', '#ffdf87', '#87afd7', '#ffafd7', '#87dfdf', '#ffffff']
endif
...
hi TabLine guifg=#bcbcbc guibg=#585858 gui=NONE cterm=NONE
...
hi ModeMsg guifg=#ffdf87 guibg=NONE gui=reverse cterm=reverse
...
hi WildMenu guifg=#000000 guibg=#ffdf87 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi TabLine ctermfg=250 ctermbg=240 cterm=NONE
