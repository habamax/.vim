...
" Last Updated: 2022-08-12 18:26:06
...
if &background ==# 'dark'
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#000000', '#870000', '#005f00', '#af875f', '#005faf', '#870087', '#005f5f', '#808080', '#626262', '#d70000', '#008700', '#d7d787', '#0087d7', '#af00af', '#5fafaf', '#ffffff']
  endif
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi dirLink ctermfg=green ctermbg=NONE cterm=NONE
    hi dirFilterMenuBookmarkPath ctermfg=darkgrey ctermbg=NONE cterm=NONE
    hi dirFilterMenuHistoryPath ctermfg=darkgrey ctermbg=NONE cterm=NONE
    hi FilterMenuDirectorySubtle ctermfg=darkgrey ctermbg=NONE cterm=NONE
    hi FilterMenuLineNr ctermfg=darkgrey ctermbg=NONE cterm=NONE
