...
" Last Updated: Tue Aug 16 15:33:22 2022
...
if &background ==# 'dark'
  ...
  hi CocMenuSel guifg=NONE guibg=#5faf5f gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi CocMenuSel ctermfg=NONE ctermbg=71 cterm=NONE
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi FilterMenuDirectorySubtle ctermfg=darkgrey ctermbg=NONE cterm=NONE
    hi FilterMenuLineNr ctermfg=darkgrey ctermbg=NONE cterm=NONE
    hi CocMenuSel ctermfg=NONE ctermbg=green cterm=NONE
...
" Color: colorCoc                #005F00        22             darkgreen
