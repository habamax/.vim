...
" Last Updated: 2022-07-09 21:14:21
...
hi dirType guifg=#5fd75f guibg=NONE gui=NONE cterm=NONE
hi dirPermissionUser guifg=#ffffff guibg=NONE gui=NONE cterm=NONE
hi dirPermissionGroup guifg=#5f87af guibg=NONE gui=NONE cterm=NONE
hi dirPermissionOther guifg=#af5f5f guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi dirType ctermfg=77 ctermbg=NONE cterm=NONE
  hi dirPermissionUser ctermfg=231 ctermbg=NONE cterm=NONE
  hi dirPermissionGroup ctermfg=67 ctermbg=NONE cterm=NONE
  hi dirPermissionOther ctermfg=131 ctermbg=NONE cterm=NONE
...
if s:t_Co >= 16
  ...
  hi dirType ctermfg=darkgreen ctermbg=NONE cterm=NONE
  hi dirPermissionUser ctermfg=white ctermbg=NONE cterm=NONE
  hi dirPermissionGroup ctermfg=darkblue ctermbg=NONE cterm=NONE
  hi dirPermissionOther ctermfg=darkred ctermbg=NONE cterm=NONE
