...
" Last Updated: Sat 02 Jul 2022 18:56:59 MSK
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#af0000', '#5fd75f', '#af875f', '#5f87af', '#d787af', '#5fafaf', '#c6c6c6', '#878787', '#ff0000', '#87ff5f', '#ffdf87', '#87afd7', '#ffafd7', '#87dfdf', '#ffffff']
endif
...
hi QuickFixLine guifg=#ffffff guibg=#87afd7 gui=NONE cterm=NONE
...
hi VisualNOS guifg=#ffffff guibg=#87dfdf gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi QuickFixLine ctermfg=231 ctermbg=110 cterm=NONE
  ...
  hi VisualNOS ctermfg=231 ctermbg=116 cterm=NONE
