...
" Last Updated: Tue Aug 16 16:21:55 2022
...
if &background ==# 'dark'
  ...
  hi PmenuSel guifg=#000000 guibg=#008700 gui=NONE cterm=NONE
  ...
  hi CocMenuSel guifg=NONE guibg=#008700 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi PmenuSel ctermfg=16 ctermbg=28 cterm=NONE
    ...
    hi CocMenuSel ctermfg=NONE ctermbg=28 cterm=NONE
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi CocMenuSel ctermfg=NONE ctermbg=darkgreen cterm=NONE
...
" Color: colorPMenuSel           #008700        28             darkgreen
