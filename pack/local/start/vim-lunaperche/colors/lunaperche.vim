...
" Last Updated: 2022-08-09 20:40:27
...
if &background ==# 'dark'
  ...
  hi Pmenu guifg=NONE guibg=#121212 gui=NONE cterm=NONE
  ...
  hi Folded guifg=#878787 guibg=#121212 gui=NONE cterm=NONE
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#000000', '#870000', '#005f00', '#af875f', '#005faf', '#870087', '#008787', '#808080', '#626262', '#d70000', '#008700', '#d7d787', '#0087d7', '#af00af', '#5fafaf', '#ffffff']
  endif
