...
" Last Updated: Sat 06 Aug 2022 15:49:42 MSK
...
if &background ==# 'dark'
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#000000', '#870000', '#005f00', '#af875f', '#005faf', '#870087', '#5f8787', '#808080', '#626262', '#d70000', '#008700', '#d7d787', '#0087d7', '#af00af', '#5fafaf', '#ffffff']
  endif
  ...
  hi dirType guifg=#5f8787 guibg=NONE gui=NONE cterm=NONE
  hi dirPermissionUser guifg=#af875f guibg=NONE gui=NONE cterm=NONE
  ...
  hi dirSizeMod guifg=#5f8787 guibg=NONE gui=NONE cterm=NONE
endif
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi dirType ctermfg=66 ctermbg=NONE cterm=NONE
    hi dirPermissionUser ctermfg=137 ctermbg=NONE cterm=NONE
    ...
    hi dirSizeMod ctermfg=66 ctermbg=NONE cterm=NONE
  endif
  unlet s:t_Co
  finish
endif
