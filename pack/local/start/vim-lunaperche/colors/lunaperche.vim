...
" Last Updated: Mon Aug 15 18:41:25 2022
...
if &background ==# 'dark'
  ...
  hi CurSearch guifg=#ffffff guibg=#5faf5f gui=NONE cterm=NONE
  ...
  hi Conceal guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi Ignore guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi DiffAdd guifg=#000000 guibg=#c0d5c0 gui=NONE cterm=NONE
  ...
  hi dirLink guifg=#5faf5f guibg=NONE gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi CurSearch ctermfg=231 ctermbg=71 cterm=NONE
    ...
    hi dirLink ctermfg=71 ctermbg=NONE cterm=bold
...
if s:t_Co >= 8
  if &background ==# 'dark'
    ...
    hi Pmenu ctermfg=black ctermbg=darkyellow cterm=NONE
    hi PmenuThumb ctermfg=NONE ctermbg=grey cterm=NONE
    hi PmenuSbar ctermfg=NONE ctermbg=NONE cterm=NONE
    hi PmenuSel ctermfg=black ctermbg=darkred cterm=NONE
    hi SignColumn ctermfg=NONE ctermbg=NONE cterm=NONE
    ...
    hi SpellCap ctermfg=darkblue ctermbg=NONE cterm=reverse,underline
...
" Color: colorMP                 #C5E7C5        30             darkcyan
" Color: diffAdd                 #C0D5C0        151            darkgreen
