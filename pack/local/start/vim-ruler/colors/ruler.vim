...
" License:      Same as Vim
" Last Updated: Thu 01 Feb 2024 19:02:16
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1c', '#d75f5f', '#00af5f', '#d7875f', '#0087d7', '#d787d7', '#5fafaf', '#d0d0d0', '#767676', '#ff5f87', '#00d75f', '#ffaf5f', '#00afff', '#ff87ff', '#5fd7d7', '#ffffff']
endif
...
hi VisualNOS guifg=#1c1c1c guibg=#5fd7d7 gui=NONE cterm=NONE
...
hi PreProc guifg=#5fafaf guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi VisualNOS ctermfg=234 ctermbg=80 cterm=NONE
