...
" Last Updated: 12.03.2022 16:53:48
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1c', '#d75f5f', '#87af87', '#afaf87', '#5f87af', '#af87af', '#5f8787', '#9e9e9e', '#767676', '#d7875f', '#afd7af', '#dfdf87', '#87afd7', '#dfafdf', '#87afaf', '#bcbcbc']
endif
...
hi ToolbarButton guifg=#1c1c1c guibg=#585858 gui=NONE cterm=NONE
...
hi ModeMsg guifg=#1c1c1c guibg=#dfafdf gui=NONE cterm=NONE
...
hi MatchParen guifg=#1c1c1c guibg=#dfafdf gui=NONE cterm=NONE
...
hi Folded guifg=#9e9e9e guibg=#303030 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi ToolbarButton ctermfg=234 ctermbg=240 cterm=NONE
  ...
  hi ModeMsg ctermfg=234 ctermbg=182 cterm=NONE
  ...
  hi MatchParen ctermfg=234 ctermbg=182 cterm=NONE
  ...
  hi Folded ctermfg=247 ctermbg=236 cterm=NONE
