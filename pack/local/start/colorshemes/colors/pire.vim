...
" Last Updated: Sun 25 Sep 2022 23:15:50 +05
...
if &background ==# 'dark'
  ...
  hi Special guifg=#d7005f guibg=NONE gui=NONE cterm=NONE
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#000000', '#af0000', '#008700', '#af5f00', '#005fd7', '#af00af', '#005f5f', '#808080', '#585858', '#d7005f', '#87d787', '#d78700', '#0087d7', '#ff00ff', '#008787', '#ffffff']
  endif
  ...
  hi Question guifg=#af00af guibg=NONE gui=NONE cterm=NONE
  ...
  hi Type guifg=#005fd7 guibg=NONE gui=NONE cterm=NONE
  ...
  hi dirType guifg=#af00af guibg=NONE gui=NONE cterm=NONE
  ...
  hi dirPermissionOther guifg=#005f5f guibg=NONE gui=NONE cterm=NONE
  ...
  hi dirSizeMod guifg=#005fd7 guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi SpellBad ctermfg=161 ctermbg=231 cterm=reverse
    hi SpellCap ctermfg=23 ctermbg=231 cterm=reverse
    hi SpellLocal ctermfg=28 ctermbg=231 cterm=reverse
    hi SpellRare ctermfg=133 ctermbg=231 cterm=reverse
