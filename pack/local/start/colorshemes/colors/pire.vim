...
" Last Updated: Sun 25 Sep 2022 22:20:16 +05
...
if &background ==# 'dark'
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#080808', '#d7005f', '#00af5f', '#af8700', '#0087d7', '#d787d7', '#00afaf', '#c6c6c6', '#767676', '#ff5f87', '#00d75f', '#ffaf00', '#00afff', '#ff87ff', '#00d7d7', '#ffffff']
  endif
  ...
  hi WarningMsg guifg=#ff5f87 guibg=NONE gui=NONE cterm=NONE
  ...
  hi dirPermissionGroup guifg=#af8700 guibg=NONE gui=NONE cterm=NONE
  ...
  hi WarningMsg guifg=#d7005f guibg=NONE gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi dirPermissionGroup ctermfg=136 ctermbg=NONE cterm=NONE
...
" Color: color03                 #af8700        136            darkyellow
