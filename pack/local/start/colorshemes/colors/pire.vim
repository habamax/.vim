...
" Last Updated: Fri 30 Sep 2022 18:51:25 +05
...
if &background ==# 'dark'
  ...
  hi diffAdded guifg=#00d75f guibg=NONE gui=NONE cterm=NONE
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#000000', '#af0000', '#008700', '#af5f00', '#005faf', '#870087', '#008787', '#d7d7d7', '#585858', '#d70000', '#87d787', '#d78700', '#0087d7', '#af00af', '#00afaf', '#ffffff']
  endif
  ...
  hi TabLineSel guifg=#d7d7d7 guibg=#000000 gui=reverse cterm=reverse
  hi ToolbarLine guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi diffAdded ctermfg=41 ctermbg=NONE cterm=NONE
    ...
    hi TabLineSel ctermfg=188 ctermbg=16 cterm=reverse
    hi ToolbarLine ctermfg=NONE ctermbg=NONE cterm=NONE
