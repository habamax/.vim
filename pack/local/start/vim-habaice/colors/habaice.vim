...
" Last Updated: 2022-06-10 23:07:11
...
hi clear
let g:colors_name = 'habaice'

let s:t_Co = exists('&t_Co') && !empty(&t_Co) && &t_Co > 1 ? &t_Co : 1

if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#af0000', '#005f00', '#875f00', '#005faf', '#870087', '#008787', '#949494', '#626262', '#af5f00', '#008700', '#d7d787', '#5f87af', '#af5faf', '#5f8787', '#e0e4e0']
endif
...
hi Statusline guifg=#e0e4e0 guibg=#626262 gui=NONE cterm=NONE
hi StatuslineTerm guifg=#e0e4e0 guibg=#626262 gui=NONE cterm=NONE
...
hi TabLineSel guifg=#000000 guibg=#e0e4e0 gui=NONE cterm=NONE
...
hi Error guifg=#af0000 guibg=#e0e4e0 gui=reverse cterm=reverse
hi ErrorMsg guifg=#af0000 guibg=#e0e4e0 gui=reverse cterm=reverse
...
hi CurSearch guifg=#e0e4e0 guibg=#875f00 gui=NONE cterm=NONE
hi WildMenu guifg=#000000 guibg=#d7d787 gui=NONE cterm=NONE
hi debugPC guifg=#e0e4e0 guibg=#005faf gui=NONE cterm=NONE
hi debugBreakpoint guifg=#e0e4e0 guibg=#af0000 gui=NONE cterm=NONE
...
hi Visual guifg=#000000 guibg=#afd7af gui=NONE cterm=NONE
hi MatchParen guifg=NONE guibg=#c5e7c5 gui=NONE cterm=NONE
hi StatuslineNC guifg=#e0e4e0 guibg=#949494 gui=NONE cterm=NONE
hi StatuslineTermNC guifg=#e0e4e0 guibg=#949494 gui=NONE cterm=NONE
...
hi DiffDelete guifg=#b0bdb0 guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi Visual ctermfg=254 ctermbg=151 cterm=NONE
  ...
  hi DiffChange ctermfg=16 ctermbg=188 cterm=NONE
...
if s:t_Co >= 16
  ...
  hi DiffDelete ctermfg=darkgray ctermbg=NONE cterm=NONE
  unlet s:t_Co
  finish
endif
...
" Color: colorV      #AFD7AF        151            green
" Color: colorMP     #C5E7C5        30             darkcyan
" Color: diffAdd     #D5D5C0        187            darkyellow
" Color: diffDelete  #B0BDB0        250            darkgray
" Color: diffChange  #D0D5D0        188            lightgray
