...
" Last Updated: 2022-06-13 11:20:26
...
hi TabLineFill guifg=NONE guibg=#000000 gui=reverse,underline cterm=reverse,underline
...
if s:t_Co >= 256
  ...
  hi TabLineFill ctermfg=NONE ctermbg=16 cterm=reverse,underline
...
if s:t_Co >= 16
  ...
  hi TabLineFill ctermfg=NONE ctermbg=black cterm=reverse,underline
  ...
  hi StatuslineTermNC ctermfg=grey ctermbg=black cterm=NONE
...
" Color: colorTab    #B2B4B2        247            grey
