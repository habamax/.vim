...
" Last Updated: 2022-06-13 8:49:38
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#870000', '#005f00', '#878700', '#005faf', '#870087', '#005f5f', '#808080', '#626262', '#af0000', '#008700', '#d7d787', '#0087d7', '#af5faf', '#5f8787', '#e4e8e4']
endif
...
hi Normal guifg=#000000 guibg=#e4e8e4 gui=NONE cterm=NONE
hi Terminal guifg=#000000 guibg=#e4e8e4 gui=NONE cterm=NONE
hi Statusline guifg=#e4e8e4 guibg=#000000 gui=bold cterm=bold
hi StatuslineTerm guifg=#e4e8e4 guibg=#000000 gui=bold cterm=bold
hi VertSplit guifg=#626262 guibg=#626262 gui=NONE cterm=NONE
hi TabLine guifg=#e4e8e4 guibg=#808080 gui=NONE cterm=NONE
hi TabLineFill guifg=NONE guibg=#808080 gui=NONE cterm=NONE
hi TabLineSel guifg=#000000 guibg=#e4e8e4 gui=bold cterm=bold
hi ToolbarLine guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi ToolbarButton guifg=#000000 guibg=#b2b6b2 gui=bold cterm=bold
hi QuickFixLine guifg=#000000 guibg=#d7d787 gui=NONE cterm=NONE
hi CursorLineNr guifg=#000000 guibg=NONE gui=bold cterm=bold
hi LineNr guifg=#b2b6b2 guibg=NONE gui=NONE cterm=NONE
hi LineNrAbove guifg=#b2b6b2 guibg=NONE gui=NONE cterm=NONE
hi LineNrBelow guifg=#b2b6b2 guibg=NONE gui=NONE cterm=NONE
hi NonText guifg=#b2b6b2 guibg=NONE gui=NONE cterm=NONE
hi FoldColumn guifg=#b2b6b2 guibg=NONE gui=NONE cterm=NONE
hi EndOfBuffer guifg=#b2b6b2 guibg=NONE gui=NONE cterm=NONE
hi SpecialKey guifg=#b2b6b2 guibg=NONE gui=NONE cterm=NONE
hi Pmenu guifg=NONE guibg=#eef3ee gui=NONE cterm=NONE
...
hi Error guifg=#870000 guibg=#e4e8e4 gui=reverse cterm=reverse
hi ErrorMsg guifg=#870000 guibg=#e4e8e4 gui=bold,reverse cterm=bold,reverse
hi ModeMsg guifg=#e4e8e4 guibg=#005faf gui=bold cterm=bold
...
hi Todo guifg=#005f5f guibg=#e4e8e4 gui=bold,reverse cterm=bold,reverse
hi Search guifg=#e4e8e4 guibg=#008700 gui=NONE cterm=NONE
hi IncSearch guifg=#e4e8e4 guibg=#000000 gui=NONE cterm=NONE
hi CurSearch guifg=#e4e8e4 guibg=#878700 gui=NONE cterm=NONE
...
hi Cursor guifg=#000000 guibg=#e4e8e4 gui=reverse cterm=reverse
hi lCursor guifg=#0000ff guibg=#000000 gui=reverse cterm=reverse
hi Visual guifg=#e4e8e4 guibg=#5f87af gui=NONE cterm=NONE
hi MatchParen guifg=NONE guibg=#c5e7c5 gui=NONE cterm=NONE
hi StatuslineNC guifg=#e4e8e4 guibg=#626262 gui=NONE cterm=NONE
hi StatuslineTermNC guifg=#e4e8e4 guibg=#626262 gui=NONE cterm=NONE
hi VisualNOS guifg=#e4e8e4 guibg=#5f8787 gui=NONE cterm=NONE
hi CursorLine guifg=NONE guibg=#d7dad7 gui=NONE cterm=NONE
hi CursorColumn guifg=NONE guibg=#d7dad7 gui=NONE cterm=NONE
hi Folded guifg=#626262 guibg=#eef3ee gui=NONE cterm=NONE
hi ColorColumn guifg=NONE guibg=#eef3ee gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi ModeMsg ctermfg=254 ctermbg=25 cterm=bold
...
" Color: color15     #e4e8e4        254            white
" Color: colorLine   #D7DAD7        253            grey
" Color: colorB      #EEF3EE        255            grey
" Color: colorNonT   #B2B6B2        249            grey
