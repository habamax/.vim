...
" Last Updated: 2022-06-15 16:27:51
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#870000', '#005f00', '#5f5f00', '#005faf', '#870087', '#005f5f', '#808080', '#626262', '#af0000', '#008700', '#d7d787', '#0087d7', '#af5faf', '#5f8787', '#e4e4e4']
endif
...
hi Special guifg=#5f5f00 guibg=NONE gui=NONE cterm=NONE
...
hi diffAdded guifg=#870000 guibg=NONE gui=NONE cterm=NONE
hi diffRemoved guifg=#005f00 guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi Special ctermfg=58 ctermbg=NONE cterm=NONE
  ...
  hi diffAdded ctermfg=88 ctermbg=NONE cterm=NONE
  hi diffRemoved ctermfg=22 ctermbg=NONE cterm=NONE
...
if s:t_Co >= 16
  ...
  hi diffAdded ctermfg=darkred ctermbg=NONE cterm=NONE
  hi diffRemoved ctermfg=darkgreen ctermbg=NONE cterm=NONE
...
" Color: color03     #5F5F00        58            darkyellow
