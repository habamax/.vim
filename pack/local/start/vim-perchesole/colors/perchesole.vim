...
" Last Updated: Sat Jul  9 19:36:11 2022
...
hi ErrorMsg guifg=#d70000 guibg=#ffffff gui=bold,reverse cterm=bold,reverse
...
hi Todo guifg=#005f5f guibg=#ffffff gui=bold,reverse cterm=bold,reverse
...
hi dirType guifg=#870000 guibg=NONE gui=NONE cterm=NONE
hi dirPermissionUser guifg=#005f5f guibg=NONE gui=NONE cterm=NONE
hi dirPermissionGroup guifg=#870087 guibg=NONE gui=NONE cterm=NONE
hi dirPermissionOther guifg=#005faf guibg=NONE gui=NONE cterm=NONE
hi dirOwner guifg=#af875f guibg=NONE gui=NONE cterm=NONE
hi dirGroup guifg=#af875f guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi ErrorMsg ctermfg=160 ctermbg=231 cterm=bold,reverse
  ...
  hi Todo ctermfg=23 ctermbg=231 cterm=bold,reverse
  ...
  hi dirType ctermfg=88 ctermbg=NONE cterm=NONE
  hi dirPermissionUser ctermfg=23 ctermbg=NONE cterm=NONE
  hi dirPermissionGroup ctermfg=90 ctermbg=NONE cterm=NONE
  hi dirPermissionOther ctermfg=25 ctermbg=NONE cterm=NONE
  hi dirOwner ctermfg=137 ctermbg=NONE cterm=NONE
  hi dirGroup ctermfg=137 ctermbg=NONE cterm=NONE
...
if s:t_Co >= 16
  ...
  hi dirType ctermfg=darkred ctermbg=NONE cterm=NONE
  ...
  hi dirOwner ctermfg=darkyellow ctermbg=NONE cterm=NONE
  hi dirGroup ctermfg=darkyellow ctermbg=NONE cterm=NONE
