...
" License:      Same as Vim
" Last Updated: 29/07/2024 12:50:52
...
hi Todo guifg=#875f00 guibg=#d7d7d7 gui=reverse cterm=reverse
hi Search guifg=#005f00 guibg=#d7d7d7 gui=reverse cterm=reverse
...
hi DiffAdd guifg=NONE guibg=#a7c7d7 gui=NONE cterm=NONE
hi DiffChange guifg=NONE guibg=#d7c7d7 gui=NONE cterm=NONE
hi DiffText guifg=NONE guibg=#a7c7d7 gui=NONE cterm=NONE
hi DiffDelete guifg=NONE guibg=#d78787 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi Todo ctermfg=94 ctermbg=188 cterm=reverse
  hi Search ctermfg=22 ctermbg=188 cterm=reverse
...
if s:t_Co >= 16
  ...
  hi Todo ctermfg=darkyellow ctermbg=gray cterm=reverse
  hi Search ctermfg=darkgreen ctermbg=gray cterm=reverse
...
" Color: diffAdd                 #a7c7d7        67             darkblue
" Color: diffDelete              #d78787        131            darkred
" Color: diffChange              #d7c7d7        96             darkmagenta
" Color: diffText                #a7c7d7        67             darkblue
