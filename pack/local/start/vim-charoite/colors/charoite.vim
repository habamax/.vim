...
" License:      Same as Vim
" Last Updated: Sun 28 Jan 2024 15:03:59
...
if &background ==# 'dark'
  ...
  hi Visual guifg=#875fff guibg=#000000 gui=reverse cterm=reverse
  hi VisualNOS guifg=#000000 guibg=#875fff gui=NONE cterm=NONE
  ...
  hi Visual guifg=#5f00d7 guibg=#ffffff gui=reverse cterm=reverse
  hi VisualNOS guifg=#ffffff guibg=#5f00d7 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi Visual ctermfg=99 ctermbg=16 cterm=reverse
    hi VisualNOS ctermfg=16 ctermbg=99 cterm=NONE
    ...
    hi Visual ctermfg=56 ctermbg=231 cterm=reverse
    hi VisualNOS ctermfg=231 ctermbg=56 cterm=NONE
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi Visual ctermfg=magenta ctermbg=black cterm=reverse
    hi VisualNOS ctermfg=black ctermbg=magenta cterm=NONE
    ...
    hi Todo ctermfg=magenta ctermbg=white cterm=reverse
    ...
    hi debugPC ctermfg=darkblue ctermbg=NONE cterm=reverse
    hi debugBreakpoint ctermfg=darkcyan ctermbg=NONE cterm=reverse
    hi Visual ctermfg=magenta ctermbg=white cterm=reverse
    hi VisualNOS ctermfg=white ctermbg=magenta cterm=NONE
    hi CursorLine ctermfg=NONE ctermbg=NONE cterm=underline
    hi CursorColumn ctermfg=black ctermbg=yellow cterm=NONE
    hi Folded ctermfg=black ctermbg=NONE cterm=bold
    hi ColorColumn ctermfg=black ctermbg=darkyellow cterm=NONE
...
if s:t_Co >= 8
  if &background ==# 'dark'
    ...
    hi debugPC ctermfg=darkblue ctermbg=NONE cterm=reverse
    hi debugBreakpoint ctermfg=darkcyan ctermbg=NONE cterm=reverse
    hi Visual ctermfg=magenta ctermbg=grey cterm=reverse
    hi MatchParen ctermfg=NONE ctermbg=NONE cterm=bold,underline
    hi VisualNOS ctermfg=black ctermbg=magenta cterm=NONE
    hi CursorLine ctermfg=NONE ctermbg=NONE cterm=underline
    hi CursorColumn ctermfg=black ctermbg=darkyellow cterm=NONE
