...
" License:      Same as Vim
" Last Updated: Sun 28 Jan 2024 19:28:18
...
if &background ==# 'dark'
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#000000', '#d75f5f', '#00af5f', '#d78700', '#0087d7', '#d787d7', '#00afaf', '#d0d0d0', '#767676', '#ff5f87', '#00d75f', '#ffaf00', '#00afff', '#ff87ff', '#00d7d7', '#ffffff']
  endif
  ...
  hi PmenuKindSel guifg=#d75f5f guibg=#ffaf00 gui=NONE cterm=NONE
  ...
  hi PreProc guifg=#d78700 guibg=NONE gui=NONE cterm=NONE
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#000000', '#af0000', '#008700', '#af5f00', '#005faf', '#870087', '#008787', '#d7d7d7', '#626262', '#d70000', '#5faf5f', '#d78700', '#0087d7', '#af00af', '#00afaf', '#ffffff']
  endif
  hi Normal guifg=#000000 guibg=#d7d7d7 gui=NONE cterm=NONE
  hi Statusline guifg=#d7d7d7 guibg=#000000 gui=bold cterm=bold
  hi StatuslineNC guifg=#d7d7d7 guibg=#626262 gui=NONE cterm=NONE
  hi VertSplit guifg=#626262 guibg=NONE gui=NONE cterm=NONE
  hi TabLine guifg=#d7d7d7 guibg=#626262 gui=NONE cterm=NONE
  ...
  hi PmenuExtra guifg=#626262 guibg=#eeeeee gui=NONE cterm=NONE
  ...
  hi Todo guifg=#5faf5f guibg=#ffffff gui=bold,reverse cterm=bold,reverse
  ...
  hi Visual guifg=#d78700 guibg=#ffffff gui=reverse cterm=reverse
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi PmenuKindSel ctermfg=167 ctermbg=214 cterm=NONE
    ...
    hi TabLine ctermfg=188 ctermbg=241 cterm=NONE
    ...
    hi PmenuExtra ctermfg=241 ctermbg=255 cterm=NONE
    ...
    hi Todo ctermfg=71 ctermbg=231 cterm=bold,reverse
    ...
    hi Visual ctermfg=172 ctermbg=231 cterm=reverse
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi Visual ctermfg=yellow ctermbg=black cterm=reverse
    ...
    hi debugPC ctermfg=darkblue ctermbg=NONE cterm=reverse
    hi debugBreakpoint ctermfg=darkcyan ctermbg=NONE cterm=reverse
    hi Visual ctermfg=yellow ctermbg=white cterm=reverse
...
" Color: colorNonT               #b2b2b2        247            darkgrey
