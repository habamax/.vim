...
" Last Updated: 2022-06-27 13:36:37
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#af0000', '#5faf5f', '#87875f', '#005faf', '#af5faf', '#5f8787', '#c6c6c6', '#878787', '#ff0000', '#87ff5f', '#dfdf5f', '#5fafff', '#d787d7', '#5fafaf', '#ffffff']
endif
...
hi ModeMsg guifg=#dfdf5f guibg=NONE gui=bold,reverse cterm=bold,reverse
...
hi Todo guifg=#5fafaf guibg=#000000 gui=bold,reverse cterm=bold,reverse
hi Search guifg=#000000 guibg=#dfdf5f gui=NONE cterm=NONE
hi IncSearch guifg=#000000 guibg=#87ff5f gui=NONE cterm=NONE
hi CurSearch guifg=#000000 guibg=#87ff5f gui=NONE cterm=NONE
hi WildMenu guifg=#000000 guibg=#dfdf5f gui=bold cterm=bold
hi debugPC guifg=#005faf guibg=NONE gui=reverse cterm=reverse
hi debugBreakpoint guifg=#5f8787 guibg=NONE gui=reverse cterm=reverse
...
hi SpellBad guifg=NONE guibg=NONE guisp=#ff0000 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=NONE
...
hi Constant guifg=#dfdf5f guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi ModeMsg ctermfg=185 ctermbg=NONE cterm=bold,reverse
  ...
  hi Todo ctermfg=73 ctermbg=16 cterm=bold,reverse
  ...
  hi debugBreakpoint ctermfg=66 ctermbg=NONE cterm=reverse
  ...
  hi Constant ctermfg=185 ctermbg=NONE cterm=NONE
