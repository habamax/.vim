" Name:         gvim
" Description:  Almost default gui vim colorscheme.
...
hi! link dirGroup NonText
hi! link dirTime NonText
...
if &background == 'dark'
  ...
  hi DiffAdd guifg=NONE guibg=#273923 guisp=NONE gui=NONE ctermfg=22 ctermbg=253 cterm=reverse term=reverse
  hi DiffChange guifg=NONE guibg=#2f2f2f guisp=NONE gui=NONE ctermfg=236 ctermbg=253 cterm=reverse term=NONE
  hi DiffDelete guifg=#767676 guibg=#2f1f1a guisp=NONE gui=NONE ctermfg=52 ctermbg=243 cterm=reverse term=reverse
  hi DiffText guifg=NONE guibg=#5f2f5f guisp=NONE gui=NONE ctermfg=53 ctermbg=253 cterm=reverse term=reverse
  ...
  hi IncSearch guifg=NONE guibg=#5f431f guisp=NONE gui=NONE ctermfg=185 ctermbg=234 cterm=reverse term=bold,reverse,underline
  ...
  hi QuickFixLine guifg=#1c1c1c guibg=#d787d7 guisp=NONE gui=NONE ctermfg=234 ctermbg=176 cterm=NONE term=NONE
  hi Removed guifg=#d75f5f guibg=NONE guisp=NONE gui=NONE ctermfg=167 ctermbg=NONE cterm=NONE term=NONE
  hi Search guifg=NONE guibg=#3a4a3a guisp=NONE gui=NONE ctermfg=71 ctermbg=234 cterm=reverse term=reverse
  ...
  if s:t_Co >= 16
    ...
    hi DiffChange ctermfg=darkgray ctermbg=white cterm=reverse
...
if &background == 'light'
  ...
  hi CursorLineNr guifg=NONE guibg=NONE guisp=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold term=bold
  hi DiffAdd guifg=NONE guibg=#e7ffe7 guisp=NONE gui=NONE ctermfg=151 ctermbg=16 cterm=reverse term=reverse
  hi DiffChange guifg=NONE guibg=#f7f5f3 guisp=NONE gui=NONE ctermfg=253 ctermbg=16 cterm=reverse term=NONE
  hi DiffDelete guifg=#767676 guibg=#faeaea guisp=NONE gui=NONE ctermfg=224 ctermbg=243 cterm=reverse term=reverse
  hi DiffText guifg=NONE guibg=#f7d7f7 guisp=NONE gui=NONE ctermfg=182 ctermbg=16 cterm=reverse term=reverse
  hi Directory guifg=NONE guibg=NONE guisp=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold term=NONE
  ...
  hi Folded guifg=#767676 guibg=#d0d0d0 guisp=NONE gui=NONE ctermfg=243 ctermbg=252 cterm=NONE term=NONE
  hi Ignore guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE term=NONE
  hi IncSearch guifg=NONE guibg=#fff0cf guisp=NONE gui=NONE ctermfg=137 ctermbg=231 cterm=reverse term=bold,reverse,underline
  ...
  hi Statement guifg=#a52a2a guisp=NONE gui=bold ctermfg=124 cterm=bold term=NONE
  ...
  hi ToolbarLine guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE term=reverse
  hi Type guifg=#2e8b57 guisp=NONE gui=bold ctermfg=29 cterm=bold term=NONE
  hi Underlined guifg=NONE guibg=NONE guisp=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline term=underline
  hi VertSplit guifg=#9e9e9e guibg=#9e9e9e guisp=NONE gui=NONE ctermfg=247 ctermbg=247 cterm=NONE term=NONE
  hi Visual guifg=NONE guibg=#cfe7fa guisp=NONE gui=NONE ctermfg=32 ctermbg=231 cterm=reverse term=reverse
  ...
  if s:t_Co >= 16
    ...
    hi Removed ctermfg=darkred ctermbg=NONE cterm=NONE
    hi Search ctermfg=green ctermbg=white cterm=reverse
    hi SpecialKey ctermfg=NONE ctermbg=NONE cterm=NONE
    hi SpellBad ctermfg=darkred ctermbg=NONE cterm=underline
    hi SpellCap ctermfg=darkyellow ctermbg=NONE cterm=underline
    hi SpellLocal ctermfg=darkgreen ctermbg=NONE cterm=underline
