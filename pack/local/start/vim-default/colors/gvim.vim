...
if &background == 'light'
  ...
  hi CursorLineNr guifg=NONE guibg=NONE guisp=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold term=bold
  hi DiffAdd guifg=NONE guibg=#dafada guisp=NONE gui=NONE ctermfg=151 ctermbg=16 cterm=reverse term=reverse
  hi DiffChange guifg=NONE guibg=#e3e3e3 guisp=NONE gui=NONE ctermfg=253 ctermbg=16 cterm=reverse term=NONE
  hi DiffDelete guifg=#767676 guibg=#ffd7d7 guisp=NONE gui=NONE ctermfg=224 ctermbg=243 cterm=reverse term=reverse
  hi DiffText guifg=NONE guibg=#f7e7f7 guisp=NONE gui=NONE ctermfg=182 ctermbg=16 cterm=reverse term=reverse
  hi Directory guifg=NONE guibg=NONE guisp=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold term=NONE
