...
if &background == 'dark'
  ...
  hi Visual guifg=#5fafd7 guibg=#000000 guisp=NONE gui=reverse ctermfg=74 ctermbg=16 cterm=reverse term=reverse
...
if &background == 'light'
  ...
  hi PmenuExtraSel guifg=#878787 guibg=#b2b2b2 guisp=NONE gui=NONE ctermfg=102 ctermbg=249 cterm=NONE term=NONE
  hi PmenuKind guifg=#5fd75f guibg=#e4e4e4 guisp=NONE gui=NONE ctermfg=77 ctermbg=254 cterm=NONE term=NONE
  hi PmenuKindSel guifg=#5fd75f guibg=#b2b2b2 guisp=NONE gui=NONE ctermfg=77 ctermbg=249 cterm=NONE term=NONE
  hi PmenuMatch guifg=#d787d7 guibg=#e4e4e4 guisp=NONE gui=NONE ctermfg=176 ctermbg=254 cterm=NONE term=NONE
  hi PmenuMatchSel guifg=#d787d7 guibg=#b2b2b2 guisp=NONE gui=NONE ctermfg=176 ctermbg=249 cterm=NONE term=NONE
  hi PmenuSbar guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE term=reverse
