" Name:         ionage
" Description:  Dark medium contrast.
" Author:       Maxim Kim <habamax@gmail.com>
" Maintainer:   Maxim Kim <habamax@gmail.com>
" License:      Vim License (see `:help license`)
" Last Updated: 12.12.2021 14:08:02
...
hi clear
let g:colors_name = 'ionage'

let s:t_Co = exists('&t_Co') && !empty(&t_Co) && &t_Co > 1 ? &t_Co : 1

if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#262626', '#d7875f', '#87af87', '#afaf5f', '#5f8787', '#875faf', '#87afaf', '#808080', '#4e4e4e', '#d75f5f', '#87af5f', '#d7d787', '#87afd7', '#af5fd7', '#87d7d7', '#e4e4e4']
  if has('nvim')
  ...
  hi ModeMsg guifg=#303030 guibg=#d7875f gui=NONE cterm=NONE
  ...
  hi Cursor guifg=#303030 guibg=#d7875f gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi ModeMsg ctermfg=236 ctermbg=173 cterm=NONE
...
if s:t_Co >= 16
  ...
  hi ModeMsg ctermfg=black ctermbg=darkred cterm=NONE
