" Name:         icedom bluce
" Description:  Blueish white colorscheme
" Author:       Maxim Kim <habamax@gmail.com>
" Maintainer:   Maxim Kim <habamax@gmail.com>
" License:      Vim License (see `:help license`)
" Last Updated: 02.10.2021 16:57:29
...
hi clear
let g:colors_name = 'icedom'

let s:t_Co = exists('&t_Co') && !empty(&t_Co) && &t_Co > 1 ? &t_Co : 2

if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1c', '#d70000', '#008700', '#af875f', '#005faf', '#5f5faf', '#5f8787', '#bcbcbc', '#808080', '#d75f5f', '#5f875f', '#d7af5f', '#0087af', '#8787d7', '#87afaf', '#eeeeee']
  if has('nvim')
  ...
  hi TabLine guifg=#000000 guibg=#eeeeee gui=NONE cterm=NONE
  ...
  hi ToolbarButton guifg=#ffffff guibg=#5f875f gui=NONE cterm=NONE
  ...
  hi ModeMsg guifg=#000000 guibg=#87afaf gui=NONE cterm=NONE
  ...
  hi Todo guifg=#808080 guibg=#eeeeee gui=NONE cterm=NONE
  hi MatchParen guifg=#ffffff guibg=#0087af gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi ToolbarButton ctermfg=231 ctermbg=65 cterm=NONE
  ...
  hi ModeMsg ctermfg=16 ctermbg=109 cterm=NONE
  ...
  hi Todo ctermfg=244 ctermbg=255 cterm=NONE
...
" Color: colorDiffA #E4EEE4 194
" Color: colorDiffC #E4E4E4 254
" Color: colorDiffD #EEE4E4 224
" Color: colorDiffT #FFFFD7 230
