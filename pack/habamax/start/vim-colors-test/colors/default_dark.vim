...
" Last Updated: 01.10.2021 11:40:43
...
hi clear
let g:colors_name = 'default_dark'

let s:t_Co = exists('&t_Co') && !empty(&t_Co) && &t_Co > 1 ? &t_Co : 2

if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#cd0000', '#00cd00', '#cdcd00', '#0000ee', '#cd00cd', '#00cdcd', '#e5e5e5', '#7f7f7f', '#ff0000', '#00ff00', '#ffff00', '#5c5cff', '#ff00ff', '#00ffff', '#ffffff']
  hi Normal guifg=#e5e5e5 guibg=#000000 gui=NONE cterm=NONE
  ...
  hi Cursor guifg=#000000 guibg=#e5e5e5 gui=NONE cterm=NONE
  ...
  hi Pmenu guifg=fg guibg=#ff00ff gui=NONE cterm=NONE
...
if s:t_Co >= 256
  hi Normal ctermfg=254 ctermbg=16 cterm=NONE
  ...
  hi Cursor ctermfg=16 ctermbg=254 cterm=NONE
  ...
  hi ToolbarLine ctermfg=NONE ctermbg=242 cterm=underline
  hi ToolbarButton ctermfg=16 ctermbg=254 cterm=bold
  hi Pmenu ctermfg=fg ctermbg=201 cterm=NONE
  hi PmenuSbar ctermfg=NONE ctermbg=248 cterm=NONE
  hi PmenuSel ctermfg=242 ctermbg=16 cterm=NONE
