...
" Last Updated: 26.12.2021 12:01:48
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#303030', '#d75f5f', '#87af87', '#d7af5f', '#5f87af', '#875faf', '#87afaf', '#808080', '#444444', '#d7875f', '#afd7af', '#d7d787', '#87afd7', '#af87d7', '#87d7d7', '#d0d0d0']
  if has('nvim')
