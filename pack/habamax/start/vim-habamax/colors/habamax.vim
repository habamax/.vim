...
" Last Updated: 25.12.2021 23:07:56
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1c', '#d7875f', '#87af87', '#d7af5f', '#5f87af', '#875faf', '#87afaf', '#808080', '#444444', '#d75f5f', '#afd7af', '#d7d787', '#87afd7', '#af5fd7', '#87d7d7', '#d0d0d0']
  if has('nvim')
