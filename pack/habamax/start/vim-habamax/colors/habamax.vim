...
" Last Updated: 28.12.2021 10:06:51
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#262626', '#d75f5f', '#87af87', '#afaf87', '#5f87af', '#af87af', '#5f8787', '#808080', '#4e4e4e', '#d7875f', '#afd7af', '#d7d787', '#87afd7', '#d7afd7', '#87afaf', '#bcbcbc']
  ...
  hi IncSearch guifg=#262626 guibg=#87af87 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi IncSearch ctermfg=235 ctermbg=108 cterm=NONE
