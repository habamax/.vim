...
" Last Updated: 25.12.2021 23:00:03
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1c', '#d7875f', '#87af87', '#d7af5f', '#5f87af', '#875faf', '#87afaf', '#808080', '#444444', '#d75f5f', '#87af5f', '#d7d787', '#87afd7', '#af5fd7', '#87d7d7', '#d0d0d0']
  if has('nvim')
  ...
  hi Todo guifg=#87d7d7 guibg=#444444 gui=NONE cterm=NONE
  ...
  hi Cursor guifg=#1c1c1c guibg=#af5fd7 gui=NONE cterm=NONE
  ...
  hi SpecialComment guifg=#af5fd7 guibg=NONE gui=NONE cterm=NONE
  hi Directory guifg=#875faf guibg=NONE gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  hi Todo ctermfg=116 ctermbg=238 cterm=NONE
  ...
  hi SpecialComment ctermfg=134 ctermbg=NONE cterm=NONE
  hi Directory ctermfg=97 ctermbg=NONE cterm=bold
...
" Color: color13     #AF5FD7        134            magenta
