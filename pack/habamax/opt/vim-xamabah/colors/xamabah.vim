...
" Last Updated: 26.03.2021 6:55:38
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1c', '#d75f5f', '#5f875f', '#af8700', '#5f87af', '#5f5f87', '#5f8787', '#6c6c6c', '#444444', '#d78787', '#87af87', '#d7af5f', '#8fafd7', '#8787af', '#5fafaf', '#ffffff']
  if has('nvim')
  ...
  hi DiffText guifg=#000000 guibg=#8787af gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi DiffText ctermfg=16 ctermbg=103 cterm=NONE
