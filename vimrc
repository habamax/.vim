...
set foldmethod=indent foldminlines=4 foldnestmax=3
...
nnoremap <space>fd <scriptcmd>fuzzy.GitFile(fnamemodify($DOCS ?? '~/docs', ":p:h"))<CR>
...
augroup xterm256 | au!
    au BufEnter *doc/habamax.txt runtime scripts/colorize_xterm.vim
augroup END
