...
" Last Updated: 04.10.2020 17:51:33
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#e0e3e3', '#a52a2a', '#2a872f', '#6a0dad',
  ...
  hi Question guifg=#2a872f guibg=NONE gui=NONE cterm=NONE
  ...
  hi IncSearch guifg=#e0e3e3 guibg=#af00af gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi IncSearch ctermfg=254 ctermbg=127 cterm=NONE
