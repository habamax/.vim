...
" Last Updated: Tue 30 Jun 2020 11:04:57 AM MSK
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['#202531', '#dedede', '#dedede', '#dedede',
          \ '#dedede', '#dedede', '#dedede', '#333b4f', '#6d7079', '#dedede',
          \ '#dedede', '#dedede', '#dedede', '#dedede', '#dedede', '#dedede']
    if has('nvim')
      let g:terminal_color_0 = '#202531'
      let g:terminal_color_1 = '#dedede'
      let g:terminal_color_2 = '#dedede'
      let g:terminal_color_3 = '#dedede'
      let g:terminal_color_4 = '#dedede'
      let g:terminal_color_5 = '#dedede'
      let g:terminal_color_6 = '#dedede'
      let g:terminal_color_7 = '#333b4f'
      let g:terminal_color_8 = '#6d7079'
      let g:terminal_color_9 = '#dedede'
      let g:terminal_color_10 = '#dedede'
      let g:terminal_color_11 = '#dedede'
      let g:terminal_color_12 = '#dedede'
      let g:terminal_color_13 = '#dedede'
      let g:terminal_color_14 = '#dedede'
    ...
    hi Search guifg=#202531 guibg=#dedede guisp=NONE gui=NONE cterm=NONE
    ...
    hi lCursor guifg=#dedede guibg=#dedede guisp=NONE gui=NONE cterm=NONE
    if !s:italics
  ...
  " Light background
  let g:terminal_ansi_colors = ['#ffffff', '#000000', '#000000', '#000000',
        \ '#000000', '#000000', '#000000', '#cacbcc', '#707070', '#000000',
  ...
  hi lCursor guifg=#000000 guibg=#000000 guisp=NONE gui=NONE cterm=NONE
  if !s:italics
    hi Comment gui=NONE cterm=NONE
  endif
  unlet s:t_Co s:italics
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi Search ctermfg=235 ctermbg=253 cterm=NONE
  ...
  hi lCursor ctermfg=16 ctermbg=16 cterm=NONE
  if !s:italics
    hi Comment cterm=NONE
  endif
  unlet s:t_Co s:italics
