...
" Last Updated: Tue 30 Jun 2020 11:17:59 AM MSK
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['#202531', '#202531', '#202531', '#202531',
          \ '#202531', '#202531', '#202531', '#333b4f', '#6d7079', '#202531',
          \ '#202531', '#202531', '#202531', '#202531', '#202531', '#dedede']
    if has('nvim')
      let g:terminal_color_0 = '#202531'
      let g:terminal_color_1 = '#202531'
      let g:terminal_color_2 = '#202531'
      let g:terminal_color_3 = '#202531'
      let g:terminal_color_4 = '#202531'
      let g:terminal_color_5 = '#202531'
      let g:terminal_color_6 = '#202531'
      let g:terminal_color_7 = '#333b4f'
      let g:terminal_color_8 = '#6d7079'
      let g:terminal_color_9 = '#202531'
      let g:terminal_color_10 = '#202531'
      let g:terminal_color_11 = '#202531'
      let g:terminal_color_12 = '#202531'
      let g:terminal_color_13 = '#202531'
      let g:terminal_color_14 = '#202531'
    ...
    hi PmenuSel guifg=#202531 guibg=#6d7079 guisp=NONE gui=NONE cterm=NONE
    ...
    hi MatchParen guifg=NONE guibg=#dedede guisp=NONE gui=NONE cterm=NONE
    ...
    hi lCursor guifg=#dedede guibg=#202531 guisp=NONE gui=NONE cterm=NONE
    if !s:italics
  ...
  " Light background
  let g:terminal_ansi_colors = ['#ffffff', '#ffffff', '#ffffff', '#ffffff',
        \ '#ffffff', '#ffffff', '#ffffff', '#cacbcc', '#707070', '#ffffff',
  ...
  hi PmenuSel guifg=#ffffff guibg=#707070 guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi PmenuSel ctermfg=235 ctermbg=242 cterm=NONE
    ...
    hi lCursor ctermfg=253 ctermbg=235 cterm=NONE
    if !s:italics
...
" Color: diff3  #f9d999 ~
" Color: diff4  #f9c9c9 ~
" Term colors: bg0  bg0 bg0 bg0 bg0 bg0 bg0 bg1
" Term colors: grey bg0 bg0 bg0 bg0 bg0 bg0 fg0
" Background: dark
" Color: grey   #6d7079 ~
" Color: fg0    #dedede ~
" Color: bg0    #202531 ~
