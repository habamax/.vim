...
" GUI only simplified version (gruvbox hard)
...
if &background ==# 'dark'
    ...
    hi ToolbarButton guifg=#f9f5d7 guibg=#665c54 guisp=NONE gui=bold cterm=bold
    ...
    hi ErrorMsg guifg=#f9f5d7 guibg=#9d0006 guisp=NONE gui=NONE cterm=NONE
    ...
    hi ToolbarButton guifg=#1d2021 guibg=#bdae93 guisp=NONE gui=bold cterm=bold
