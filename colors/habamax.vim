...
" Last Updated: 10.08.2020 22:43:49
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#000000', '#e77575', '#8ec07c', '#e7c088',
        \ '#6aa6ca', '#af87af', '#86c1b9', '#333b4a', '#6d7079', '#e77575',
        \ '#8ec07c', '#e7c088', '#6aa6ca', '#af87af', '#86c1b9', '#bcbcbc']
  if has('nvim')
    let g:terminal_color_0 = '#000000'
    let g:terminal_color_1 = '#e77575'
    let g:terminal_color_2 = '#8ec07c'
    let g:terminal_color_3 = '#e7c088'
    ...
    let g:terminal_color_11 = '#e7c088'
  ...
  if get(g:, 'habamax_transp_bg', 0)
    ...
    hi Normal guifg=#bcbcbc guibg=#000000 guisp=NONE gui=NONE cterm=NONE
  endif
  hi EndOfBuffer guifg=#333b4a guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Statusline guifg=#bcbcbc guibg=#333b4a guisp=NONE gui=NONE cterm=NONE
  hi StatuslineNC guifg=#6d7079 guibg=#333b4a guisp=NONE gui=NONE cterm=NONE
  hi StatuslineTerm guifg=#bcbcbc guibg=#333b4a guisp=NONE gui=NONE cterm=NONE
  ...
  hi PmenuSel guifg=#000000 guibg=#e7c088 guisp=NONE gui=NONE cterm=NONE
  ...
  hi WarningMsg guifg=#e7c088 guibg=#000000 guisp=NONE gui=NONE cterm=NONE
  hi MoreMsg guifg=#e7c088 guibg=#000000 guisp=NONE gui=NONE cterm=NONE
  hi ModeMsg guifg=#e7c088 guibg=#000000 guisp=NONE gui=NONE cterm=NONE
  hi Question guifg=#8ec07c guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Todo guifg=#bcbcbc guibg=#757012 guisp=NONE gui=NONE cterm=NONE
  hi MatchParen guifg=#000000 guibg=#86c1b9 guisp=NONE gui=NONE cterm=NONE
  hi Search guifg=#000000 guibg=#e7c088 guisp=NONE gui=NONE cterm=NONE
  hi IncSearch guifg=#000000 guibg=#dc9656 guisp=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#000000 guibg=#e7c088 guisp=NONE gui=NONE cterm=NONE
  hi ColorColumn guifg=NONE guibg=#181a1f guisp=NONE gui=NONE cterm=NONE
  hi Cursor guifg=#000000 guibg=#bcbcbc guisp=NONE gui=NONE cterm=NONE
  hi lCursor guifg=#bcbcbc guibg=#dc9656 guisp=NONE gui=NONE cterm=NONE
  ...
  hi PreProc guifg=#e7c088 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Special guifg=#86c1b9 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Tag guifg=#e7c088 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi Operator guifg=#e7c088 guibg=NONE guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi Statusline ctermfg=250 ctermbg=236 cterm=NONE
  hi StatuslineNC ctermfg=242 ctermbg=236 cterm=NONE
  hi StatuslineTerm ctermfg=250 ctermbg=236 cterm=NONE
  ...
  hi MoreMsg ctermfg=180 ctermbg=16 cterm=NONE
  hi ModeMsg ctermfg=180 ctermbg=16 cterm=NONE
  hi Question ctermfg=222 ctermbg=NONE cterm=NONE
  hi Todo ctermfg=250 ctermbg=58 cterm=NONE
  ...
  hi SpellCap ctermfg=222 ctermbg=NONE cterm=underline
