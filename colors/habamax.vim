...
if &background == 'light'
    ...
    hi VertSplit guibg=NONE guifg=#707080 gui=NONE ctermbg=8 ctermfg=8 cterm=NONE
...
" Dark colors {{{1
    ...
    hi VertSplit guibg=NONE guifg=#333b4f gui=NONE ctermbg=8 ctermfg=8 cterm=NONE
