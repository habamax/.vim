...
* link:https://github.com/habamax/vim-saturnite[saturnite] -- dark background, variation of awesome https://github.com/romainl/Apprentice[Apprentice];
* link:https://github.com/habamax/vim-freyeday[freyeday] -- light background, to complement `saturnite`;
* link:https://github.com/habamax/vim-alchemist[alchemist] -- dark background, yet another variation of awesome https://github.com/romainl/Apprentice[Apprentice];
