...
# scroll popups
nnoremap <expr> <C-b> empty(popup_list()) ? '<C-b>' : '<C-S-PageUp>'
nnoremap <expr> <C-f> empty(popup_list()) ? '<C-f>' : '<C-S-PageDown>'
...
nnoremap <silent> <space>1 <scriptcmd>text.Underline('=')<CR>
nnoremap <silent> <space>2 <scriptcmd>text.Underline('-')<CR>
