...
" call minpac#add('git@github.com:habamax/vim-habanight.git', {'rev': 'master'})
" call minpac#add('git@github.com:habamax/vim-gruvbit.git', {'rev': 'master'})
" call minpac#add('git@github.com:habamax/vim-polar.git', {'rev': 'master'})
