...
# Add formatted vim objects to the current buffer, e.g. :EchoPrint getbufinfo()
command! -nargs=1 -complete=expression EchoPrint append(line('.'), json.Format(<args>)->split("\n"))
